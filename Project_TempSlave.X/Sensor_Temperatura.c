...
uint8_t digitalVal; // digital readings
uint8_t analogVal; //analog readings
...
void __interrupt() isr(void){
    ...
    if(PIR1bits.SSPIF == 1){ 
            ...
            if(!SSPSTATbits.D_nA && !SSPSTATbits.R_nW) {
                ...
                analogVal = SSPBUF;     // Guardar en el PORTD el valor del buffer de recepción
                __delay_us(250);
...
void main(void) {
    ...
    while (1){
        ...
        analogVal = ADRESH;      //Realiza conversión para leer normal
