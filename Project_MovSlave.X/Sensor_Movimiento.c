...
//******************************************************************************
void main(void) {
    initOsc(3);                         // Se usa un reloj interno de 8 MHz
    ...
    while (1){
        ...
        if (pirValue == 1) {              //No se detecta interferencia
            final_deg();                //Mantener apagado el pin de PWM
        } else {                        //Se detecta interferencia
            zero_deg();                //Encender el pin de PWM
        }
