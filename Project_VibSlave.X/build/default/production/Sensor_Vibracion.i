...
# 2 "<built-in>" 2
# 1 "Sensor_Vibracion.c" 2
# 12 "Sensor_Vibracion.c"
...
void main(void) {
    ...
    while (1){
        ...
        present_signal = PORTDbits.RD0;

        if (previous_signal != present_signal) {
            PORTAbits.RA0 = 1;
